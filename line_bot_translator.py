...
import uuid
import json
import openai  # 確保引入 openai
from linebot import LineBotApi, WebhookHandler  # 使用 v2 版本
...
# Initialize LINE API and OpenAI
...
# Language dictionaries for quick replies
lan_dic = {
    "日文": "Japanese", "英文": "English", "繁體中文": "Traditional Chinese", "韓文": "Korean", 
...
@app.route('/')
def home():
    return "Hello, this is the LINE Bot Translator!"
...
def handle_audio_message(event):
    ...
    with open('whisper_audio.m4a', 'wb') as f:
        f.write(message_content.content)
    whisper_text = openai_whisper('whisper_audio.m4a')
